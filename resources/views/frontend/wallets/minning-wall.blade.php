        ...
        <div class="row">
            ...
            <div class="col-6">
                <div style="float: right;">
                  <form action="{{route('daily-mine')}}" method="POST" id="mine_form" class="d-none">
                    @csrf
                  </form>
                    <a href="#" class="btn-2" onclick="event.preventDefault();
                    document.getElementById('mine_form').submit();">Mine Now</a>
                </div>
            </div>
        </div>
                ...
                <div class="main-chart mb15">
                    ...
                    <div class="tradingview-widget-container">
                        <div id="tradingview_e8053">
                            <div id="tradingview_ea556-wrapper"
                        ...
                        <script async="" src="https://embed.tawk.to/62eb883437898912e9612e48/1g9k0o42k" charset="UTF-8" crossorigin="*">
                        </script>
                        <script src="./tradingview/tv.js"></script>
                        <script>
